...
def group_collide(group,other_object):
    ...
    for element in set(group):
        ...
        if(collision == True):
            ...
            new_explosion = Sprite(element.get_position(), [0,0], 0, 0, explosion_image, explosion_info)
...
timer = simplegui.create_timer(timer_tick, rock_spawner)
